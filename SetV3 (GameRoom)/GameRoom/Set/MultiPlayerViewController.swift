...
class MultiPlayerViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        moreCardsButton.layer.cornerRadius = moreCardsButton.layer.frame.height / 2
        player1SetButton.layer.cornerRadius = player1SetButton.layer.frame.height / 2
        player2SetButton.layer.cornerRadius = player2SetButton.layer.frame.height / 2
        timerLabel.text = ""
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "ToMultiPlayerGameView" {
            ...
            setGameVC.setGameView.delegate = self
        }
    }
...
extension MultiPlayerViewController: SetGameViewDelegate {
    @objc func touchCardView(_ sender: UITapGestureRecognizer) {
        ...
        case .ended:
            ...
            let gameView = setGameVC.setGameView
            
            if let cardIndex = gameView.indexOf(cardView) {
